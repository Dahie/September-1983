...
namespace XnaConsole
{
    ...
    {
        static public KeyBinding[] GermanBindings = new KeyBinding[]
        {
            new KeyBinding( Keys.OemPipe, "^", "°", "", ""),
            new KeyBinding( Keys.OemBackslash, "<", ">", "|", ""),
            new KeyBinding( Keys.OemOpenBrackets, "ss", "?", "\\", ""),
            new KeyBinding( Keys.OemCloseBrackets, "", "", "", ""),
            new KeyBinding( Keys.OemSemicolon, "ue", "Ue", "", ""),
            new KeyBinding( Keys.OemPlus, "+", "*", "~", ""),
            new KeyBinding( Keys.OemTilde, "oe", "Oe", "", ""),
            new KeyBinding( Keys.OemQuotes, "ae", "Ae", "", ""),
            ...
            new KeyBinding( Keys.Add, "+", "", "", ""),
            new KeyBinding( Keys.Divide, "/", "", "", ""),
            new KeyBinding( Keys.Multiply, "*", "", "", ""),
            new KeyBinding( Keys.Subtract, "-", "", "", ""),
